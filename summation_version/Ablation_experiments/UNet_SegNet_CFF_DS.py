...
class dose_decoder(nn.Module):
    def __init__(self):
        ...
        self.DsConv1 = nn.Conv2d(64, 1, kernel_size=1, stride=1, bias=False)
        self.DsConv2 = nn.Conv2d(32, 1, kernel_size=1, stride=1, bias=False)
        self.DsConv3 = nn.Conv2d(16, 1, kernel_size=1, stride=1, bias=False)
        self.DsConv4 = nn.Conv2d(8, 1, kernel_size=1, stride=1, bias=False)
    ...
    def forward(self, x5, x4, x3, x2, x1, s4, s3, s2, s1):
        ...
        return dose_result, DS4, DS3, DS2, DS1
...
class UNet_SegNet_CFF(nn.Module):
    ...
    def forward(self, x):
        ...
        dose_result, DS4, DS3, DS2, DS1 = self.doseDec(x5, x4, x3, x2, x1, s4, s3, s2, s1)
...
def main():
    ...
    seg_out, dose_out, DS4, DS3, DS2, DS1 = model(x)
    print(seg_out.shape)
