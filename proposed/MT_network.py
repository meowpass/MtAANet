...
class shared_encoder(nn.Module):
    def __init__(self):
        ...
        self.conv_first = nn.Conv2d(in_channels=1, out_channels=2, kernel_size=3, stride=1, padding=1)
        self.conv1 = conv_block(2)
        self.conv2 = conv_block(8)
        self.conv3 = conv_block(32)
        self.conv4 = conv_block(128)
        self.conv5 = conv_block(512)
...
class dose_decoder(nn.Module):
    def __init__(self, in_channel=2048):
        ...
        self.conv_middle = nn.Conv2d(in_channel, out_channels=in_channel, kernel_size=3, stride=1, padding=1,
                                     bias=False)
        self.channel_match1 = channel_match(1024)
        self.channel_match2 = channel_match(256)
        self.channel_match3 = channel_match(64)
        self.channel_match4 = channel_match(16)
...
class MT_architecture(nn.Module):
    ...
    def forward(self, x):
        ...
        dose_result,up1 = self.dose_dec(x5, x4, x3, x2, x1, d4, d3, d2, d1)
        return seg_result, dose_result,up1
